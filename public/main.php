...
<head>
    ...
    <title>Minha Loja - E-commerce Completo (Alpine.js)</title>
    ...
    <style>
        ...
        .navbar-taller { min-height: 70px; padding-top: 0.75rem; padding-bottom: 0.75rem; }
                        ...
                        <div class="list-group list-group-flush">
                            <template x-for="product in offerProducts.slice(0, 3)" :key="product.id">
                                <div class="list-group-item d-flex align-items-center p-2 bg-light rounded-3 mb-2">
                                    ...
                                    <button class="btn btn-sm btn-outline-danger" @click="toggleWishlist(product)">
        ...
        <div class="collapse bg-white border-bottom shadow-sm d-lg-none" id="search-bar-full">
            <div class="container-fluid py-3">
                <form class="d-flex mb-4">
                    <input class="form-control form-control-lg rounded-pill me-2" type="search" placeholder="Buscar produtos...">
