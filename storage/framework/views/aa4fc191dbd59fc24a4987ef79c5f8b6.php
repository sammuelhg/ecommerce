...
<div class="py-5 position-relative" style="background-color: <?php echo e($storeSettings['color_category_bar'] ?? '#fff9f0ff'); ?>; color: #212529;">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="<?php echo e(route('landing.history')); ?>" class="text-light text-decoration-none d-flex align-items-center">
