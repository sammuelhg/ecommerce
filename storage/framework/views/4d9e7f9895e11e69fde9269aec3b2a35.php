<div class="row">
    <div class="col-12">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($images || $tempImages): ?>
            <h6 class="text-muted border-bottom pb-2 mb-3 mt-4">
                <i class="bi bi-cloud-plus"></i> Novas Imagens (<?php echo e(count($images) + count($tempImages)); ?>)
            </h6>
            <div class="row row-cols-2 row-cols-md-4 row-cols-lg-6 g-3 mb-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col" wire:key="livewire-temp-<?php echo e($index); ?>">
                        <div class="card h-100 border-success border-2 shadow-sm image-card">
                            <div class="position-relative">
                                <img src="<?php echo e($image->temporaryUrl()); ?>" class="card-img-top" style="aspect-ratio: 1; object-fit: cover; cursor: pointer;" 
                                     onclick="openCropper('<?php echo e($image->temporaryUrl()); ?>', 'livewire-<?php echo e($index); ?>')"
                                     alt="Nova imagem">
                                ...
                                <div class="image-actions">
                                    <button type="button" onclick="openCropper('<?php echo e($image->temporaryUrl()); ?>', 'livewire-<?php echo e($index); ?>')" class="btn btn-sm btn-info text-white me-1" title="Recortar">
                                        <i class="bi bi-crop"></i>
                                    </button>
                                    <button type="button" wire:click="removeTempImage(<?php echo e($index); ?>)" class="btn btn-sm btn-danger" title="Remover">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tempImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $path): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col" wire:key="custom-temp-<?php echo e($index); ?>">
                        <div class="card h-100 <?php echo e($newMainImageIndex === $index ? 'border-primary border-3 shadow' : 'border-success border-2 shadow-sm'); ?> image-card">
                            <div class="position-relative">
                                <img src="<?php echo e(asset('storage/' . $path)); ?>" class="card-img-top" style="aspect-ratio: 1; object-fit: cover; cursor: pointer;" 
                                     onclick="openCropper('<?php echo e(asset('storage/' . $path)); ?>', <?php echo e($index); ?>)"
                                     alt="Nova imagem">
                                
                                <span class="position-absolute top-0 start-0 m-2 badge <?php echo e($newMainImageIndex === $index ? 'bg-primary' : 'bg-success'); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($newMainImageIndex === $index): ?>
                                ...
                                <!-- Actions Overlay -->
                                <div class="image-actions">
                                    <button type="button" wire:click="setNewMainImage(<?php echo e($index); ?>)" class="btn btn-sm <?php echo e($newMainImageIndex === $index ? 'btn-warning' : 'btn-outline-warning text-white'); ?> me-1" title="Definir como Capa">
                                        <i class="bi <?php echo e($newMainImageIndex === $index ? 'bi-star-fill' : 'bi-star'); ?>"></i>
                                    </button>
                                    <button type="button" onclick="openCropper('<?php echo e(asset('storage/' . $path)); ?>', <?php echo e($index); ?>)" class="btn btn-sm btn-info text-white me-1" title="Recortar">
                                        <i class="bi bi-crop"></i>
                                    </button>
                                    <button type="button" wire:click="removeTempImage(<?php echo e($index); ?>)" class="btn btn-sm btn-danger" title="Remover">
                                        <i class="bi bi-trash"></i>
