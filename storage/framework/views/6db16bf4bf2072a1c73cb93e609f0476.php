<div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <h4 class="mb-0 fw-bold text-dark">
                        <?php echo e($productId ? 'Editar Produto' : 'Novo Produto'); ?>
    ...
    <div class="container-fluid px-4 pb-5">
        ...
        <div class="card border-0 shadow-sm mb-4" 
             x-data="{
                 types: <?php echo \Illuminate\Support\Js::from($types->pluck('name', 'id')->toArray())->toHtml() ?>,
                 models: <?php echo \Illuminate\Support\Js::from($models->pluck('name', 'id')->toArray())->toHtml() ?>,
                 materials: <?php echo \Illuminate\Support\Js::from($materials->pluck('name', 'id')->toArray())->toHtml() ?>,
                 colors: <?php echo \Illuminate\Support\Js::from($colors->pluck('name', 'id')->toArray())->toHtml() ?>,
                 sizes: <?php echo \Illuminate\Support\Js::from($sizes->pluck('name', 'id')->toArray())->toHtml() ?>,
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="col-md-3 text-end">
                        ...
                        <div class="form-check form-switch form-switch-lg d-inline-block">
                            ...
                            <label class="form-check-label fw-bold <?php echo e($is_active ? 'text-success' : 'text-muted'); ?>" for="statusSwitch">
