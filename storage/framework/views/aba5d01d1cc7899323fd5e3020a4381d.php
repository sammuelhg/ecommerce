...
[$__name, $__params] = $__split('shop.product-card', ['product' => $product]);

$key = 'search-'.$product->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2998429457-0', 'search-'.$product->id);
