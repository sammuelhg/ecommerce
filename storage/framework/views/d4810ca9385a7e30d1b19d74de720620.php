...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasUser">
    ...
    <div class="offcanvas-body p-0">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($storyStatus) && $storyStatus->hasActiveStories): ?>
            <div class="p-3">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
            ...
            <div class="p-4 border-bottom bg-light">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="position-relative me-3" 
                         <?php if(isset($storyStatus) && $storyStatus->hasActiveStories): ?>
                             style="cursor: pointer;"
                             data-bs-toggle="modal" 
                             data-bs-target="#storyViewerModal"
                         <?php endif; ?>
                    >
                        ...
                        <div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center overflow-hidden position-relative"
                             style="width: 60px; height: 60px; font-size: 24px; z-index: 2; <?php if(isset($storyStatus) && $storyStatus->hasActiveStories): ?> background-color: #1a1a1a !important; <?php endif; ?>">
                            <img src="<?php echo e(Auth::user()->avatar_url); ?>" alt="<?php echo e(Auth::user()->name); ?>" class="w-100 h-100 object-fit-cover">
                        </div>
                    </div>
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="<?php echo e(route('user.addresses')); ?>" class="list-group-item list-group-item-action">
                    <i class="bi bi-geo-alt me-2 text-primary"></i> Endereços
                </a>
                <a href="<?php echo e(route('user.payments')); ?>" class="list-group-item list-group-item-action">
        ...
        <?php else: ?>
            ...
            <div class="p-4">
                <div class="text-center mb-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($storeSettings['profile_logo'])): ?>
                        <img src="<?php echo e($storeSettings['profile_logo']); ?>" alt="Logo Perfil" class="rounded-circle mb-3" style="width: 80px; height: 80px; object-fit: cover;">
                    <?php else: ?>
                ...
                <div class="d-flex gap-2 mb-4">
                    <a href="<?php echo e(route('social.redirect', 'google')); ?>" class="btn btn-light border flex-fill d-flex align-items-center justify-content-center" style="height: 40px;">
                        <img src="<?php echo e(asset('google.svg')); ?>" alt="Google" style="width: 20px; height: 20px;">
                    </a>
                    <a href="<?php echo e(route('social.redirect', 'facebook')); ?>" class="btn btn-primary flex-fill d-flex align-items-center justify-content-center" style="height: 40px; background-color: #1877F2; border-color: #1877F2;">
                    ...
                    <div class="tab-pane fade show active" id="login" role="tabpanel">
                        <form method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                                <a href="<?php echo e(route('password.request')); ?>" class="btn btn-link w-100 text-center">
                                    Esqueci minha senha
                                </a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </form>
...
<?php /**PATH C:\xampp\htdocs\ecommerce\ecommerce-hp\resources\views/shop/partials/user-offcanvas.blade.php ENDPATH**/ ?>