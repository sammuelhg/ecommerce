                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        <div class="list-group-item p-5 text-center text-muted">
                            ...
                            <h5 class="mb-2">Nenhum endereço cadastrado</h5>
                            <p class="small">Adicione um endereço para facilitar suas compras.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.shop', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\ecommerce-hp\resources\views/user/addresses.blade.php ENDPATH**/ ?>