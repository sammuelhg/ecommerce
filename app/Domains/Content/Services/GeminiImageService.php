...
class GeminiImageService
{
    ...
    {
        $this->apiKey = \App\Domains\Shared\Models\StoreSetting::get('gemini_api_key') ?: config('services.gemini.api_key', 'AIzaSyDipBtMGE_V9oqIsTatKLC0uqdXHIEPrWc');
    }
    ...
    private function buildPrompt(array $data): string
    {
        ...
        try {
            return app(\App\Domains\Content\Services\AiContentService::class)->buildImagePrompt($data);
        } catch (\Exception $e) {
