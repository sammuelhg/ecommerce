...
class AiContentService
{
    ...
    public function buildSeoPrompt(array $data): string
    {
        ...
        $template = \App\Domains\Shared\Models\StoreSetting::get('ai_seo_prompt_template', 
    ...
    public function buildFullDescriptionPrompt(array $data): string
    {
        ...
        $template = \App\Domains\Shared\Models\StoreSetting::get('ai_description_prompt_template', 
    ...
    {
        $provider = \App\Domains\Shared\Models\StoreSetting::get('ai_provider', 'gemini');
    ...
    {
        $apiKey = \App\Domains\Shared\Models\StoreSetting::get('gemini_api_key') ?: config('services.gemini.api_key');
    ...
    {
        $apiKey = \App\Domains\Shared\Models\StoreSetting::get('openai_api_key');
    ...
    {
        $apiKey = \App\Domains\Shared\Models\StoreSetting::get('deepseek_api_key');
